...
class ClientConfig(object):
    ...
    def __init__(self, config, directory=None):
        ...
        Args:
          ...
          directory (string): Absolute Path to the directory containing the extension. If not specified the validator will ONLY check the validity of the config passed to it.
        """
    ...
    def directory(self, value):
        ...
        value_dir.setFilter(QtCore.QDir.Executable|QtCore.QDir.Files)
